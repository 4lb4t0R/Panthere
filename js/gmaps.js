...
!(function (e, t) {
						...
						if ("marker" === e) {
							...
							o.setMap(s.map),
								(o.draw = function () {
									...
									(t.pixel = n.fromLatLngToContainerPixel(r)),
										O(e, t);
								});
						} else O(e, t);
	...
	return (
		...
		(p.prototype.getElevations = function (e) {
			(e = n({ locations: [], path: !1, samples: 256 }, e)).locations
				.length > 0 &&
			...
			if (r)
				for (var g, h, u = 0; (t = r[u]); u++) {
					...
					t.size && "normal" !== t.size
						...
						: t.icon &&
						  (g.push("icon:" + encodeURI(t.icon)), delete t.icon),
					t.color &&
		...
		"object" == typeof window.google &&
			...
			google.maps.Polygon.prototype.containsLatLng ||
				(google.maps.Polygon.prototype.containsLatLng = function (e) {
					...
					for (
						var o = !1, n = this.getPaths().getLength(), r = 0;
						r < n;
						r++
					)
						for (
		...
		Array.prototype.indexOf ||
			(Array.prototype.indexOf = function (e) {
				...
				if (
					...
					return -1;
				for (
					var r = n >= 0 ? n : Math.max(o - Math.abs(n), 0);
					r < o;
					r++
				)
