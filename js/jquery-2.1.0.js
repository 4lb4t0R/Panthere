/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (
						...
						for (t in e)
							(n = s[t]),
								s !== (r = e[t]) &&
									(l &&
									r &&
									(h.isPlainObject(r) || (i = h.isArray(r)))
										? (i
												? ((i = !1),
												  (o =
														n && h.isArray(n)
				...
				return i !== f && 9 === i.nodeType && i.documentElement
					? ((f = i),
					  ...
					  (r.find.CLASS =
							n.getElementsByClassName &&
							function (e, t) {
								return typeof t.getElementsByClassName !== E &&
									d
		...
		function xe(e) {
			for (
				...
				if ((n = r.relative[e[l].type])) p = [ge(me(p), n)];
					...
					if (
						(n = r.filter[e[l].type].apply(null, e[l].matches))[y]
					) {
		...
		function we(e, t, i, o) {
			...
			if (!o && 1 === p.length) {
				if (
					...
					if (
						!(t = (r.find.ID(l.matches[0].replace(ee, te), t) ||
							[])[0])
					)
						return i;
			...
			return (
				s(e, p)(o, t, !d, i, (K.test(e) && fe(t.parentNode)) || t), i
			);
		}
		return (
	...
	(h.filter = function (e, t, n) {
		...
		h.fn.extend({
			find: function (e) {
				...
				return (
					((r = this.pushStack(n > 1 ? h.unique(r) : r)).selector =
			...
			function (e, t) {
				h.fn[e] = function (n, r) {
					...
					return (
						...
						this.length > 1 &&
							(D[e] || h.unique(i), E.test(e) && i.reverse()),
						this.pushStack(i)
					);
				};
			}
							...
							(c = h.extend(
								{
									...
									selector: i,
									needsContext:
										i && h.expr.match.needsContext.test(i),
									namespace: g.join("."),
								},
								o
							)),
				...
				for (l = (t = (t || "").match(A) || [""]).length; l--; )
					if (
						...
						s &&
							!p.length &&
							((f.teardown &&
								!1 !== f.teardown.call(e, g, v.handle)) ||
		...
		trigger: function (t, n, r, i) {
			...
			if (
				...
				3 !== r.nodeType &&
					...
					((t = t[h.expando]
						? t
						: new h.Event(m, "object" == typeof t && t)).isTrigger =
						i ? 2 : 3),
					(t.namespace = v.join(".")),
				...
				for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
					(t.type = o > 1 ? u : d.bindType || m),
						(f =
							(F.get(s, "events") || {})[t.type] &&
							F.get(s, "handle")) && f.apply(s, n),
						(f = c && s[c]) &&
							f.apply &&
							h.acceptData(s) &&
	...
	function fe(e, t) {
		...
		if (1 === t.nodeType) {
			...
			P.hasData(e) &&
				((a = P.access(e)), (u = h.extend({}, a)), P.set(t, u));
		}
	}
	function pe(e, t) {
	...
	(se.optgroup = se.option),
		...
		h.fn.extend({
			...
			empty: function () {
				for (var e, t = 0; null != (e = this[t]); t++)
					1 === e.nodeType &&
						(h.cleanData(pe(e, !1)), (e.textContent = ""));
				return this;
			},
			clone: function (e, t) {
				return (
			...
			domManip: function (e, t) {
				...
				if (
					...
					for (
						s = (o = h.map(pe(n, "script"), ue)).length;
						c > l;
						l++
					)
						(a = n),
		...
		h.each(
			...
			function (e, t) {
				h.fn[e] = function (e) {
					for (
						var n, r = [], i = h(e), s = i.length - 1, a = 0;
						s >= a;
						a++
					)
		...
		return (
			n ||
				(("none" !== (n = me(e, t)) && n) ||
					((t = (he = (
						he ||
						h("<iframe frameborder='0' width='0' height='0'/>")
	...
	function Se(e, t) {
		if (t in e) return t;
		for (
			var n = t[0].toUpperCase() + t.slice(1), r = t, i = je.length;
			i--;
	...
	function qe(e, t, n) {
		...
		if (0 >= i || null == i) {
			if (
				((0 > (i = we(e, t, o)) || null == i) && (i = e.style[t]),
				xe.test(i))
			)
				return i;
			...
			function (e, t, n) {
				...
				for (r in (n.queue ||
					...
					c.always(function () {
						c.always(function () {
							a.unqueued--,
								h.queue(e, "fx").length || a.empty.fire();
						});
					})),
				1 === e.nodeType &&
					("height" in t || "width" in t) &&
					((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
					"none" === (l = h.css(e, "display")) &&
						(l = ve(e.nodeName)),
					"inline" === l &&
						"none" === h.css(e, "float") &&
				...
				if (e && 3 !== o && 8 !== o && 2 !== o)
					return typeof e.getAttribute === X
						...
						: ((1 === o && h.isXMLDoc(e)) ||
								...
								(r =
									h.attrHooks[t] ||
									(h.expr.match.bool.test(t) ? Ue : void 0))),
						  void 0 === n
	...
	h.fn.extend({
		val: function (e) {
			...
			return arguments.length
				...
				? (t =
						h.valHooks[i.type] ||
						h.valHooks[i.nodeName.toLowerCase()]) &&
				  "get" in t &&
		...
		h.extend({
			...
			ajax: function (e, t) {
				...
				c.ifModified &&
					...
					h.etag[r] &&
						w.setRequestHeader("If-None-Match", h.etag[r])),
				...
				h
					...
					.done(function (e) {
						(o = arguments),
							s.html(
								r
									? h("<div>").append(h.parseHTML(e)).find(r)
									: e
							);
					})
					.complete(
