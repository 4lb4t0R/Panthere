				...
				if (
					...
					if (
						...
						if ((!a && 27 != i.which) || (a && 27 == i.which))
							return (
								27 == i.which && s.find(n).trigger("focus"),
								o.trigger("click")
							);
						var r = s.find(
	...
	(function (t) {
		...
		(e.VERSION = "3.3.5"),
			...
			(e.prototype.init = function (e, i, o) {
				...
				for (
					var n = this.options.trigger.split(" "), s = n.length;
					s--;
			...
			(i.prototype.checkPosition = function () {
				if (this.$element.is(":visible")) {
					...
					if (this.affixed != r) {
						...
						(this.affixed = r),
							(this.unpin =
								"bottom" == r ? this.getPinnedOffset() : null),
							this.$element
								.removeClass(i.RESET)
								.addClass(l)
								.trigger(
