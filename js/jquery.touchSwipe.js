					...
					((P = new (function (n, D) {
						function P(n) {
							if (
								!(
									...
									e(n.target).closest(D.excludedElements, me)
										.length > 0
								)
							) {
						...
						function L(n) {
							var c,
								...
								h,
								f,
								d = n.originalEvent ? n.originalEvent : n;
							if (xe !== E && xe !== m && !B()) {
								var T,
									b = d.touches,
									x = b ? b[0] : d,
						...
						function A(e) {
							var n = e.originalEvent ? e.originalEvent : e;
							D.triggerOnTouchLeave && ((xe = U(E)), j(n, xe));
						}
						function I() {
							me.unbind(ae, P),
								me.unbind(pe, k),
						...
						function H() {
							var e = !0;
							return (
								null !== D.threshold && (e = he >= D.threshold),
								e
							);
						}
						function _() {
							...
							return (
								null !== D.cancelThreshold &&
									null !== fe &&
									(e = ee(fe) - he >= D.cancelThreshold),
								e
							);
						}
						function q() {
							return !(
								D.maxTimeThreshold && ge >= D.maxTimeThreshold
							);
						}
						function Q() {
							var e = Y(),
						...
						function B() {
							...
							if (Pe) {
								var n = le() - Pe;
								n <= D.fingerReleaseThreshold && (e = !0);
							}
							return e;
						}
						function J(e) {
						...
						var D = e.extend({}, D),
							oe = x || O || !D.fallbackToMouseEvents,
							ae = oe
								? O
									? S
										? "MSPointerDown"
